...
def make_explain():
    ...
    p_provider=patentInfoProvider()
    explanation=p_provider.create_and_store_explain(apply_number,heading,key_id,param_exp,t_object=target_object,parameter=parameter)
    struct_exp=p_provider.structure_explanation(explanation["patent_explanation"]["output"])
